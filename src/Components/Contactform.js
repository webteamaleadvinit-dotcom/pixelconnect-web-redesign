    ...
    return(
      ...
      <div className="absolute bottom-[-6rem] right-[-6rem] w-[28rem] h-[28rem] bg-gradient-to-r from-purple-400 via-pink-500 to-orange-400 rounded-full blur-3xl opacity-30 animate-[float_10s_ease-in-out_infinite_reverse]"></div>
              ...
              <div className="mb-5">
                ...
                <p><input type="text" placeholder="Your name" onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="h-10 w-64 xl:w-full rounded-md bg-slate-100"/>{errors.name && (
              ...
              <div className="mb-5">
                ...
                onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="h-10 w-64 xl:w-full rounded-md bg-slate-100"/>{errors.email && (
              ...
              <div className="mb-5">
                ...
                onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="h-10 w-64 xl:w-full rounded-md bg-slate-100"/>{errors.message && (
              ...
              <div className="mb-5">
                ...
                onChange={(e) =>setFormData({ ...formData, message: e.target.value })} className="h-20 w-64 xl:w-full rounded-md bg-slate-100"></textarea>{errors.message && (
                <p className="text-red-500 text-sm mt-1">{errors.message}</p>
              )}</p>
              </div>

              <button type="submit" className="w-40 h-10 bg-blue-500 ring-offset-2 ring ring-blue-500 text-white">Send Message</button>
            </form>
