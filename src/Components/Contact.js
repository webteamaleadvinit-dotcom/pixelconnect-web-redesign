      ...
      <div className="absolute bottom-[-6rem] right-[-6rem] w-[28rem] h-[28rem] bg-gradient-to-r from-purple-400 via-pink-500 to-orange-400 rounded-full blur-3xl opacity-30 animate-[float_10s_ease-in-out_infinite_reverse]"></div>
        <div className="container mx-auto pt-15">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4 pt-5">
              <figure className="bg-white rounded-2xl sm:w-96 sm:h-64 sm:mx-auto md:w-80 xl:w-64 text-center pt-10 mb-10 shadow hover:shadow-lg hover:shadow-indigo-500/40">
              ...
              <figure className="bg-white rounded-2xl sm:w-96 sm:h-64 sm:mx-auto md:w-80 xl:w-64 text-center pt-10 mb-10 shadow hover:shadow-lg hover:shadow-indigo-500/40">
                <div className="bg-blue-500 rounded-lg w-24 h-24 p-6 mx-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"><a href="" className="text-4xl text-white"><i class="fa-brands fa-linkedin-in"></i></a></div>
                <figcaption className="p-5">
              ...
              <figure className="bg-white rounded-2xl sm:w-96 sm:h-64 sm:mx-auto md:w-80 xl:w-64 text-center pt-10 mb-10 shadow hover:shadow-lg hover:shadow-indigo-500/40">
                <div className="bg-pink-500 rounded-lg w-24 h-24 p-6 mx-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"><a href="" className="text-4xl text-white"><i class="fa-brands fa-instagram"></i></a></div>
                <figcaption className="p-5">
