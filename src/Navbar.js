...
const Navbar=()=>{
    ...
    return(
        ...
        <div className="lg:hidden bg-blue-400 px-4 pb-4 space-y-2">
            <ul>
                    <li>
                        <Link to="/" className="text-base font-semibold hover:text-sky-600">Home</Link>
                    </li>
                    <li>
                        <Link to="/" className="text-base font-semibold hover:text-sky-600">Services</Link>
                    </li>
                    <li>
                ...
                <ul className="hidden lg:flex justify-evenly">
                    <li>
                        <Link to="/" className="text-base font-semibold hover:text-sky-600 hover:border-b-2 border-indigo-500">Home</Link>
                    </li>
                    <li>
                        <Link to="/" className="text-base font-semibold hover:text-sky-600 hover:border-b-2 border-indigo-500">Services</Link>
                    </li>
                    <li>
